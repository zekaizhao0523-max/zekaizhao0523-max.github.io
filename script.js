...
const languageCopy = {
  zh: {
    ...
    entries: [
      ...
      { selector: "#projects .project-note", text: "两个个人项目均由我一人 vibe coding 完成，覆盖需求拆解、交互原型、前后端实现与部署验证。" },
      ...
      { selector: ".project-card:nth-child(2) img:nth-child(1)", attr: "alt", text: "CheckMyStat 球员档案移动端 demo" },
      { selector: ".project-card:nth-child(2) img:nth-child(2)", attr: "alt", text: "CheckMyStat 图表生成移动端 demo" },
      { selector: ".project-card:nth-child(2) img:nth-child(3)", attr: "alt", text: "CheckMyStat 赛程日志移动端 demo" },
  ...
  en: {
    ...
    entries: [
      ...
      { selector: "#projects .project-note", text: "Both personal projects were individually vibe-coded by me, covering requirement breakdown, interaction prototyping, frontend/backend implementation, and deployment validation." },
      { selector: ".project-card:nth-child(1) .project-type", text: "AI Agent · LangGraph" },
      ...
      { selector: ".project-card:nth-child(2) img:nth-child(1)", attr: "alt", text: "CheckMyStat player profile mobile demo" },
      { selector: ".project-card:nth-child(2) img:nth-child(2)", attr: "alt", text: "CheckMyStat chart export mobile demo" },
      { selector: ".project-card:nth-child(2) img:nth-child(3)", attr: "alt", text: "CheckMyStat schedule log mobile demo" },

...
const languageCopy = {
  zh: {
    ...
    entries: [
      ...
      { selector: ".project-card:nth-child(1) .project-topline a", text: "GitHub" },
      ...
      { selector: ".project-card:nth-child(1) .project-metrics span:nth-child(1)", text: "8 类售后问题" },
      { selector: ".project-card:nth-child(1) .project-metrics span:nth-child(2)", text: "9 条规则知识库" },
      { selector: ".project-card:nth-child(1) .project-metrics span:nth-child(3)", text: "7 项结构化输出" },
      ...
      { selector: ".project-card:nth-child(2) .project-topline a", text: "GitHub" },
      ...
      { selector: ".project-card:nth-child(2) .project-metrics span:nth-child(1)", text: "多维 NBA 数据" },
      { selector: ".project-card:nth-child(2) .project-metrics span:nth-child(2)", text: "Canvas 可视化" },
      { selector: ".project-card:nth-child(2) .project-metrics span:nth-child(3)", text: "生产部署资产" },
  ...
  en: {
    ...
    entries: [
      ...
      { selector: ".project-card:nth-child(1) .project-metrics span:nth-child(1)", text: "8 issue classes" },
      { selector: ".project-card:nth-child(1) .project-metrics span:nth-child(2)", text: "9 business rules" },
      { selector: ".project-card:nth-child(1) .project-metrics span:nth-child(3)", text: "7 structured fields" },
      ...
      { selector: ".project-card:nth-child(2) .project-metrics span:nth-child(1)", text: "Multi-source NBA data" },
      { selector: ".project-card:nth-child(2) .project-metrics span:nth-child(2)", text: "Canvas visualization" },
      { selector: ".project-card:nth-child(2) .project-metrics span:nth-child(3)", text: "Deployment assets" },

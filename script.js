...
const languageCopy = {
  zh: {
    ...
    entries: [
      ...
      { selector: ".hero-bullets li:nth-child(3)", text: "关注大模型自动化分析、RAG 商业应用与因果推断在经营决策中的落地。" },
      ...
      { selector: ".profile-copy li:nth-child(4)", html: "<span class=\"text-highlight\">AI 方向：</span>关注并擅长 LLM、Attention、提示工程、RAG、因果推断与自动化分析工具，期待参与 AI 驱动的数据科学体系建设。" },
  ...
  en: {
    ...
    entries: [
      ...
      { selector: ".hero-bullets li:nth-child(3)", text: "Interested in LLM-based automated analysis, RAG for business workflows, and causal inference in operational decision-making." },
      ...
      { selector: ".profile-copy li:nth-child(4)", html: "<span class=\"text-highlight\">AI focus:</span> I actively practice LLMs, Attention, prompt engineering, RAG, causal inference, and automated analysis tools, with the goal of contributing to AI-driven data science systems." },
      { selector: "#education .section-kicker", text: "Education" },
